...
public class AboutHomeComponent extends BaseComponent {
    ...
    /**
     * Navigate directly to a panel by its panel ID (UUID).
     * <p>
     * If the panel ID is not part of the active Home Panel configuration, the
     * default about:home panel is displayed.
     *
     * @param panelId
